...
urlpatterns_project = [
    path(route="upload", view=views.UploadAPI.as_view(), name="upload"),
    path(route="catalog", view=views.DatasetCatalog.as_view(), name="catalog"),
    path(
        route="download-format",
        view=views.DownloadDatasetCatalog.as_view(),
        name="download-format",
    ),
    path(route="download", view=views.DownloadAPI.as_view(), name="download-dataset"),
    path(route="statistics", view=views.StatisticsAPI.as_view(), name="statistics"),
    path(route="labels", view=views.LabelList.as_view(), name="label_list"),
    path(
        route="label-upload", view=views.LabelUploadAPI.as_view(), name="label_upload"
    ),
    path(
    ...
    path(route="examples", view=views.ExampleList.as_view(), name="example_list"),
    path(
    ...
    # Todo: remove.
    path(route="docs", view=views.DocumentList.as_view(), name="doc_list"),
    path(
    ...
    path(route="tags", view=views.TagList.as_view(), name="tag_list"),
    path(route="tags/<int:tag_id>", view=views.TagDetail.as_view(), name="tag_detail"),
    path(
    ...
    path(route="roles", view=views.RoleMappingList.as_view(), name="rolemapping_list"),
    path(
...
urlpatterns = [
    path(route="health", view=views.Health.as_view(), name="health"),
    path("auth/", include("dj_rest_auth.urls")),
    path("fp/", include("django_drf_filepond.urls")),
    path("auth/register/", include("dj_rest_auth.registration.urls")),
    path(route="me", view=views.Me.as_view(), name="me"),
    path(route="features", view=views.Features.as_view(), name="features"),
    path(route="projects", view=views.ProjectList.as_view(), name="project_list"),
    path(route="users", view=views.Users.as_view(), name="user_list"),
    path(route="roles", view=views.Roles.as_view(), name="roles"),
    path(
